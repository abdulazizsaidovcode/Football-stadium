...
const AddStadium = () => {
    ...
    useEffect(() => {
        getUserLocation(setUserLocation).then(() => console.log('success'));
    }, [setUserLocation]);
            ...
            <ScrollView style={{paddingHorizontal: getSize('defaultPadding')}}>
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View>
                        ...
                        <View
                            style={{borderRadius: 20, overflow: 'hidden', height: screenHeight / 3, marginBottom: 12}}>
                            <MapView
              ...
              {images.map((image, index) => (
                <Image source={{ uri: image }} key={index} style={styles.image} />
                        ...
                        <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                            <View style={{width: '47%'}}>
                                ...
                                <Pressable onPress={showStartPicker} style={{
                                    padding: 12,
                                    backgroundColor: colors.inDarkGreen,
                                    borderRadius: 10,
                                    marginTop: 10
                                    ...
                                    <Text style={{
                                        ...
                                        color: colors.white,
                                        fontSize: 16
                                    }}>{formatTime(`${startTime.getHours()}:${startTime.getMinutes()}`)}</Text>
                                </Pressable>
                                <DateTimePickerModal
                            ...
                            <View style={{width: '47%'}}>
                                ...
                                <Pressable onPress={showEndPicker} style={{
                                    padding: 12,
                                    backgroundColor: colors.inDarkGreen,
                                    borderRadius: 10,
                                    marginTop: 10
                                    ...
                                    <Text style={{
                                        ...
                                        color: colors.white,
                                        fontSize: 16
                                    }}>{formatTime(`${endTime.getHours()}:${endTime.getMinutes()}`)}</Text>
                                </Pressable>
                                <DateTimePickerModal
                ...
                />
                        ...
                        <View style={{marginVertical: 20}}>
                            <Buttons isDisebled={!isFormValid || true} title='Saqlash' loading={isLoading}
                                     onPress={submitStadiumPost}/>
                        </View>
                    </View>
                </TouchableWithoutFeedback>
            </ScrollView>
