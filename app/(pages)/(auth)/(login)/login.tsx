...
const Login = () => {
    ...
    useEffect(() => {
        if (sendCode.response) navigation.navigate('(pages)/(auth)/(check-code)/check-code');
    }, [sendCode.response]);
    ...
    useFocusEffect(
        useCallback(() => {
            if (isPhoneNumberComplete) userFound.globalDataFunc();
        }, [phoneNumber])
    )
                    ...
                    {!status && (
                        <View style={{
                            ...
                            <Text style={{alignItems: 'center'}}>
                                ...
                                <Text
                                    style={styles.links}
                                    onPress={() => navigation.navigate('(pages)/offer/policy-offer')}>
                                    Maxfiylik siyosati
                                </Text>
                                <Text style={styles.label}> va </Text>
                                <Text
                                    style={styles.links}
                                    onPress={() => navigation.navigate('(pages)/offer/user-offer')}>
                                    foydalanuvchi qo‘llanmasini
                                </Text>
                                <Text style={styles.label}> o‘qib chiqdim va roziman.</Text>
                            </Text>
                        </View>
                    )}
                </View>
